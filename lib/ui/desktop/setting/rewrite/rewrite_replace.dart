  ...
  Widget headers() {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Headers(headers: rewriteItem.headers, key: _headerKey),
        ),
      ],
    );
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  onChanged: (val) =>
                      rewriteItem.statusCode = int.tryParse(val),
