...
class _ScriptWidgetState extends State<ScriptWidget> {
  ...
  bool onKeyEvent(KeyEvent event) {
    ...
    if ((HardwareKeyboard.instance.isMetaPressed ||
      ...
      HardwareKeyboard.instance.removeHandler(onKeyEvent);
      if (_refresh) {
        _refreshScript(force: true).whenComplete(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
              Icons.update,
              color: scrollEnd ? Theme.of(context).colorScheme.primary : null,
            ),
          ),
          const SizedBox(width: 10),
          IconButton(
        ...
        FilledButton(
          onPressed: () async {
            ...
            if (widget.scriptItem == null) {
              ...
              await (await ScriptManager.instance).addScript(
                scriptItem,
                script.text,
              );
            } else {
              ...
              (await ScriptManager.instance).updateScript(
                widget.scriptItem!,
                script.text,
              );
            }
                          ...
                          Obx(
                            () => SizedBox(
                              ...
                              child: FilledButton.tonalIcon(
                                onPressed: _fetchingRemoteScript.value
                                    ? null
                                    : _fetchRemoteScript,
    ...
    showContextMenu(
      ...
      items: [
        ...
        PopupMenuItem(
          ...
          onTap: () => removeScripts(selected.toList()),
        ),
      ],
    );
  }
  ...
  void showMenus(TapDownDetails details, int index) {
    ...
    showContextMenu(
      ...
      items: [
        ...
        PopupMenuItem(
          height: 35,
          child: widget.scripts[index].enabled
