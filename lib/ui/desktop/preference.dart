          ...
          children: [
            Row(
              children: [
                SizedBox(
                  width: 100,
                  child: Text("${localizations.language}: ", style: titleStyle),
                ),
                DropdownButton<Locale>(
                  value: appConfiguration.language,
                  onChanged: (Locale? value) =>
                      appConfiguration.language = value,
            ...
            Row(
              children: [
                SizedBox(
                  width: 100,
                  child: Text("${localizations.theme}: ", style: titleStyle),
                ),
                DropdownButton<ThemeMode>(
                  value: appConfiguration.themeMode,
                  onChanged: (ThemeMode? value) =>
                      appConfiguration.themeMode = value!,
                  focusColor: Colors.transparent,
                  items: [
                    DropdownMenuItem(
            ...
            Tooltip(
              ...
              child: Row(
                children: [
                  SizedBox(
                    width: 100,
                    child: Text("Material3: ", style: titleStyle),
                  ),
                  Transform.scale(
                    scale: 0.75,
                    child: Switch(
            ...
            ListTile(
              ...
              subtitle: Text(
                localizations.minimizeToTraySubtitle,
                style: subtitleStyle,
              ),
            ...
            ListTile(
              ...
              subtitle: Text(
                localizations.headerExpandedSubtitle,
                style: subtitleStyle,
              ),
              trailing: SwitchWidget(
                scale: 0.75,
