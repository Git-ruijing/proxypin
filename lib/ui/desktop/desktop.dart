...
class _DesktopHomePagePageState extends State<DesktopHomePage>
    implements EventListener {
  static final container = ListenableList<HttpRequest>();

  static final GlobalKey<DesktopRequestListState> requestListStateKey =
      GlobalKey<DesktopRequestListState>();
  ...
  void initState() {
    ...
    panel = NetworkTabController(
      tabStyle: const TextStyle(fontSize: 16),
          ...
          Expanded(
            child: VerticalSplitView(
              ...
              onRatioChanged: (ratio) {
                widget.appConfiguration.panelRatio = double.parse(
              ...
              left: ValueListenableBuilder(
                ...
                builder: (_, index, __) => LazyIndexedStack(
