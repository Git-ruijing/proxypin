...
class _QrCodePageState extends State<QrCodePage>
  ...
  late List<Tab> tabs = [Tab(text: 'Encode'), Tab(text: 'Decode')];
  ...
  Widget build(BuildContext context) {
    ...
    tabs = [Tab(text: localizations.encode), Tab(text: localizations.decode)];
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          _QrEncode(windowId: widget.windowId),
          _QrDecode(windowId: widget.windowId),
        ],
      ),
    );
  }
...
class _QrDecodeState extends State<_QrDecode>
            ...
            children: [
              TextField(
                ...
                decoration: decoration(
                  context,
                  label: localizations.encodeResult,
                ),
              ),
              SizedBox(height: 8),
              TextButton.icon(
