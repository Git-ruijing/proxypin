...
class _ExternalProxyDialogState extends State<ExternalProxyDialog> {
  ...
  void initState() {
    ...
    if (widget.configuration.externalProxy != null) {
      externalProxy = ProxyInfo.fromJson(
        widget.configuration.externalProxy!.toJson(),
      );
    }
  }
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  flex: 2,
                  child: Text(localizations.mobileDisplayPacketCapture),
                ),
                Expanded(
                  child: SwitchWidget(
            ...
            Text(
              localizations.externalProxyServer,
            ...
            Text(
              localizations.externalProxyAuth,
              style: const TextStyle(fontWeight: FontWeight.w500),
            ),
            const SizedBox(height: 10),
            SizedBox(
        ...
        if (mounted) {
          await showDialog(
            ...
            builder: (_) => AlertDialog(
              ...
              content: Text(
                localizations.externalProxyFailureConfirm,
