                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(width: 15),
                      const Expanded(
                        child: Text('URL', style: TextStyle(fontSize: 14)),
                      ),
                      SizedBox(
                        width: 60,
                        child: Text(
  ...
  showEdit([int? index]) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return RequestBlockAddDialog(
          requestBlockManager: widget.requestBlockManager,
          index: index,
        );
      },
    ).then((value) {
...
class RequestBlockAddDialog extends StatelessWidget {
  ...
  const RequestBlockAddDialog({
    super.key,
    required this.requestBlockManager,
    this.index,
  });
  ...
  Widget build(BuildContext context) {
    ...
    RequestBlockItem item = index == null
        ? RequestBlockItem(true, '', BlockType.values.first)
        : requestBlockManager.list.elementAt(index!);
