...
class MobileRequestBreakpointPage extends StatefulWidget {
  ...
  @override
  State<MobileRequestBreakpointPage> createState() =>
      _RequestBreakpointPageState();
}
  ...
  Future<void> _export(
    ...
    try {
      ...
      final path = await FilePicker.platform.saveFile(
        fileName: 'request_breakpoints.json',
        bytes: bytes,
      );
      if (path == null) return;
...
class MobileBreakpointRuleEditor extends StatefulWidget {
  ...
  @override
  State<MobileBreakpointRuleEditor> createState() =>
      _MobileBreakpointRuleEditorState();
}

class _MobileBreakpointRuleEditorState
    extends State<MobileBreakpointRuleEditor> {
